...
public class Equipe2 extends JFrame {
    ...
    public Equipe2() {
        ...
        try {
            ...
            // Créer la requête SQL pour récupérer les lignes de la table employe où Num_equipe = 2
            String requeteSQL = "SELECT cin, nom, prenom,num_equipe, poste, telephone FROM employe WHERE num_equipe = 2";
