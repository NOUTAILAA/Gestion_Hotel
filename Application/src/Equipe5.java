...
public class Equipe5 extends JFrame {
    ...
    public Equipe5() {
        ...
        try {
            ...
            // Créer la requête SQL pour récupérer les lignes de la table employe où Num_equipe = 5
            String requeteSQL = "SELECT cin, nom, prenom,num_equipe, poste, telephone FROM employe WHERE num_equipe = 5";
