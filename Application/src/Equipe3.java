...
public class Equipe3 extends JFrame {
    ...
    public Equipe3() {
        ...
        try {
            ...
            // Créer la requête SQL pour récupérer les lignes de la table employe où Num_equipe = 3
            String requeteSQL = "SELECT cin, nom, prenom,num_equipe, poste, telephone FROM employe WHERE num_equipe = 3";
